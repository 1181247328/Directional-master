...
public class PeriodAdapter extends BaseAdapter {
    ...
    private String TAG = PeriodAdapter.class.getSimpleName();
    ...
    @Override
    public int getCount() {
        return direState.getPeriodList().size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_period, null);
        ...
        //图片
        imageLoader.displayImage(DirectAddaress.ADDRESS + direState.getPeriodList().get(position).getImg(),
                viewHolder.ivCementItemImage,
                direState.getImageLoaderOptions(R.mipmap.not_loaded, R.mipmap.not_loaded, R.mipmap.not_loaded));
        //标题
        viewHolder.tvCementItemTimer.setText(direState.getPeriodList().get(position).getTitle());
        //线路起始点
        viewHolder.tvCementItemTitle.setText(direState.getPeriodList().get(position).getName());
        //简介
        viewHolder.tvCementItemIntroduction.setText(direState.getPeriodList().get(position).getIntroduction());
        return convertView;
    }
