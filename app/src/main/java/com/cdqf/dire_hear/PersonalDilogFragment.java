...
public class PersonalDilogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private void initPersonalDilogView() {
        //本地相册
        tvSeabedHeadLocal = personalDialog.findViewById(R.id.tv_seabed_head_local);
        //拍照上传
        tvSeabedHeadTake = personalDialog.findViewById(R.id.tv_seabed_head_take);
    }
        ...
        switch (requestCode) {
            ...
            case REQUEST_CODE_CROP:
                if (resultCode == RESULT_OK) {
                    ...
                    direState.setHeadBitmap(bitmap);
                    direState.saveBitmapFile(bitmap, FileUtil.IMG_CACHE4);
