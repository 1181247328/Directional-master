...
//                ImageSource image = Global.getTestImage(position);
            Global.getImageLoader(getApplicationContext()).displayImage("file://" + pageList.get(position), piv, direState.getImageLoaderOptions(R.mipmap.not_loaded, R.mipmap.not_loaded, R.mipmap.not_loaded));
